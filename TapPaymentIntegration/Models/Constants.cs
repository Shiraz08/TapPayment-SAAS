...
namespace TapPaymentIntegration.Models
{
    public static class Constants
    {
        ...
        public static readonly string NETWORKCREDENTIALUSERNAME = "billing@tamarran.com";
        public static readonly string NETWORKCREDENTIALPASSWORD = "wziw fovd ewwh wyuk";
        public static readonly string MAINEMAILADDRESS = "billing@tamarran.com";
